...
const Profile = () => {
    ...
    return <>
        <div className="w-full mx-auto mt-20 flex flex-col justify-center items-center ">
            ...
            <span className="text-lg text-cyan-900 mt-5 text-center font-bold">John Doe</span>
            <span className="text-lg text-cyan-900 mt-2 text-center">example123@gmail.com</span>

            <div className="flex justify-center mt-10">
                <span class="bg-blue-100 text-blue-800 text-lg font-medium mx-3 p-3 rounded-md text-center">
                    <div>40</div>
                    <span>Products</span>
                </span>
                <span class="bg-orange-100 text-orange-800 text-lg font-medium mx-3 p-3 rounded-md text-center">
                    <div>40</div>
                    <span>Products</span>
                </span>
                <span class="bg-green-100 text-green-800 text-lg font-medium mx-3 p-3 rounded-md text-center">
                    <div>40</div>
                    <span>Products</span>
                </span>
            </div>
